System.register(["@angular/router", "@angular/core", "./item.service", "./auth.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var router_1, core_1, item_service_1, auth_service_1, ItemDetailViewComponent;
    return {
        setters: [
            function (router_1_1) {
                router_1 = router_1_1;
