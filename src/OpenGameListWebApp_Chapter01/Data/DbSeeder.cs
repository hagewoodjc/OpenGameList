...
namespace OpenGameList.Data
{
    public class DbSeeder
    {
        ...
        public async Task SeedAsync()
        {
            ...
            //CreateUsersAsync default Items (if there are none)
        ...
        private async Task CreateUsersAsync()
        {
            ...
            // Insert "Admin" into the Dtabase and also assign the  "Administrator" role to him.
        ...
        private void CreateItems()
        {
            ...
            EntityEntry<Item> e1 = DbContext.Items.Add(new Item()
            {
                ...
                LastModifiedDated = lastModifiedDate
            });
            ...
            EntityEntry<Item> e2 = DbContext.Items.Add(new Item()
            {
                ...
                Text = @"The Minetest gameplay is very similar to Minecraft's: you are playing in a 3D open world, where you canb create and/or remove various types of blocks. 
                        MineTest features both single-player and multi-player game modes. It also has support for custom mods, additional texture packs and other custom/personalization options.
            ...
            EntityEntry<Item> e3 = DbContext.Items.Add(new Item()
            {
                ...
                Text = @"Relic Hunters Zero is fast, tactical and also very smooth to play. It also enables the users to look at the source code, so they can get creative and keep this 
                            game alive, fun and free for years to come. The game is also available on Steam.",
                Notes = "This is a sample record created by the Code-First Configuration class",
                ViewCount = 5230,
                CreateDate = createdDate,
                LastModifiedDated = lastModifiedDate
            ...
            EntityEntry<Item> e4 = DbContext.Items.Add(new Item()
            {
                ...
                Text = @"The game is currently under Milestone 3. The Milestone 2, which is currently out, features the following: 
                            ...
                            - a final boss in Icy City
                            - new and improved soundtracks anf sound effects ... and much more!
            ...
            EntityEntry<Item> e5 = DbContext.Items.Add(new Item()
            {
                ...
                Text = @"Scrabble 3D extends the gameplay of the classic game Scrabble by adding a new whole third dimension. 
                        Other than playing left to right or top to bottom, you'll be able to place your tiles above or beyond other tiles. Since the game features more fields, 
                        it also uses a larger letter set. You can either play against the computer, players from your LAN or from the Internet. The game also features a set of game 
                        servers where you can challenge players from all over the world and get ranked into an official, ELO-based rating/ladder system.",
                Notes = "This is a sample record created by the Code-First Configuration class",
                ViewCount = 6754,
                CreateDate = createdDate,
                LastModifiedDated = lastModifiedDate
        ...
        private Item GetSampleItem(int id, string authorId, int viewCount, DateTime createDate)
        {
            return new Item()
            {
                UserId = authorId,
        ...
        /// </summary>
        private Comment GetSampleComment(int n, int itemId, string authorId, DateTime createDate)
        {
            return new Comment()
            {
                ItemId = itemId,
